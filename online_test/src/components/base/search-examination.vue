...
export default {
  ...
  methods: {
    ...
    getSearchData () { // 搜索试卷
      ...
      const url = 'http://udog.beautop.cn:33833/gdy/question_bank/xukubao_api?s=Index&m=Api&a=paperSearch&accessKey=37f600e9c80494c20d950d3081e497e5' // 试卷
