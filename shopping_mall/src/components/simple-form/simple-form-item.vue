  ...
  computed: {
    ...
    currentComponent() {
      ...
      switch (this.type) {
        ...
        // 图片上传
        case "upload-images":
          currentComponent = "upload-images";
          break;
        // 文本
        case "text":
          currentComponent = "just-text";
          break;
        // 图片
        case "img":
          currentComponent = "just-img";
          break;
  ...
  methods: {
    ...
    valueChange(val) {
      if (this.currentComponent == "date-picker") {
        this.$emit("input", val);
      } else if (this.currentComponent == "i-select") {
        let config = this.otherConfig || {};
        this.$emit("update-select-label", {
          label: (val && val.label) || "",
